...
if(isset($_GET['resultados'])){
   include("taxonomy-votacion-asamblea-ciudadana_resultado.php");
   exit(0);
}
    ...
    <div class="row">
      ...
      <main class="site-main col-12" id="main">
        ...
        <header class="page-header">
          <h1 class="entry-title"><?php echo _x( 'Candidaturas al CCE y a la Secretaría General Estatal', 'lista', 'pgi-import' );?></h1>
          <p><?php echo _x( 'A continuación encontrarás el listado de las candidaturas al CCE y a la Secretaría General estatal que hemos recibido. El orden en el que aparecen las candidaturas es aleatorio y cambia periódicamente.', 'lista', 'pgi-import' );?></p>
        ...
        <div class="acordion" id="opciones">
          ...
          <div class="row">
            <div class="col-12">
            	<?php get_template_part( 'loop-templates/content-lista' ); ?>
            </div>
          </div>
          <?php endwhile; ?>
        </div>
